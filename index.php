...
$exec_str = "echo $ip_address | awk '{match$0,((25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){1,3}(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)); ip = substr($0,RSTART,RLENGTH); print ip}'";$ip_address = exec($exec_str,$test);
echo "Your IP address is ", $ip_address, "<br>";
